...
namespace Yahoo.Business.Defaults
{
    public class DefaultSubCategory : ISubCategory
    {
        ...
        public DefaultSubCategory(IBusinessFactory factory, int id)
        {
        ...
        internal DefaultSubCategory(IBusinessFactory factory, SubCategoryData data)
        {
            this.factory = factory;
            this.data = data;
        }
        ...
        {
            var user = new DefaultUser(this.factory, name: name);
