...
namespace Yahoo.Business.Security
{
    ...
    public class DefaultSecurityService : ISecurityService
    {
        ...
        UserInfo ISecurityService.GetUser(int userId)
        {
        ...
        IEnumerable<Privilege> ISecurityService.GetPrivileges(int userId)
        {
        ...
        Authorization ISecurityService.GetAuthorization(int userId, string url)
        {
            throw new NotImplementedException();
        }


        void ISecurityService.Authorize(int userId, string url, Authorization authorization)
        {
            throw new NotImplementedException();
        }
    }
