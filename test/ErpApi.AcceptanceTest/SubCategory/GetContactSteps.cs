...
namespace ErpApi.AcceptanceTest.SubCategory
{
    [Binding]
    [Scope(Feature = "GetContact")]
    public class GetContactSteps
    {
        private readonly HttpContext context;

        public GetContactSteps(HttpContext context)
        {
        ...
        {
            this.context.Send(HttpMethod.Post, "api/SubCategory/GetContact");
        }
