...
namespace ErpApi.AcceptanceTest.User
{
    ...
    public partial class GetProfileFeature
    {
        
        private static TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "GetProfile.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "GetProfile", "In order to 顯示線上操作者的資訊\r\nAs a 線上操作者\r\nI want to 取得操作者的資訊", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void TestInitialize()
        {
            if (((TechTalk.SpecFlow.FeatureContext.Current != null) 
                        && (TechTalk.SpecFlow.FeatureContext.Current.FeatureInfo.Title != "GetProfile")))
            {
                ErpApi.AcceptanceTest.User.GetProfileFeature.FeatureSetup(null);
            }
        }
